...
import Anika from "../ElectionsPage/pics/politician8.jpg"
...
export interface Anika{
    changePage: (page: pages) => void;
    you: Person;
}

class AnikaPage extends React.Component<Anika> {
    render() {
        return (
            <div>
              <NavBar
...
function mapStateToProps(state: IPoliquickState) {
  ...
  export { connectedComponent as AnikaPage }
