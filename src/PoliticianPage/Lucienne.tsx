...
import Luci from "../ElectionsPage/pics/politician5.jpg"
...
function mapStateToProps(state: IPoliquickState) {
  ...
  export { connectedComponent as LuciPage }
